...
public class UnprotectValidation {

    public static void validateUnprotect(List<String> userInput) throws Exception {

        if (userInput.size() != 4) {
            throw new Exception("Invalid unprotect command");
        }
